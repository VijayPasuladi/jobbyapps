              ...
              {skills.map(eachItem => (
                <li className="li-job-details-container" key={eachItem.name}>
                  <img
                    ...
                    alt={eachItem.name}
                  />
                  <p className="description-job-heading">{eachItem.name}</p>
                </li>
              ))}
            </ul>
            <div className="company-life-img-container">
              <div className="life-heading-para-container">
                <h1 className="description-job-heading">Life at Company</h1>
                <p className="description">{lifeAtCompany.description}</p>
              </div>
              <img src={lifeAtCompany.imageUrl} alt="life at company" />
            </div>
          </div>
          <h1 className="description-job-heading">Similar Jobs</h1>
